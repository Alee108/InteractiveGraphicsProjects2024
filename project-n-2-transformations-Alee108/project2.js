...
function GetTransform( positionX, positionY, rotation, scale )
{
	...
	return Array(scale*Math.cos(new_rotation), scale*Math.sin(new_rotation), 0, -scale*Math.sin(new_rotation), scale*Math.cos(new_rotation), 0, positionX, positionY, 1 );
}
